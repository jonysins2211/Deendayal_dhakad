...
URL = "https://movie-loverz-bot3-a1ece55b18d2.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else "https://movie-loverz-bot3-a1ece55b18d2.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-loverz-bot3-a1ece55b18d2.herokuapp.com/".format(FQDN)
else:
    URL = "https://movie-loverz-bot3-a1ece55b18d2.herokuapp.com/".format(FQDN)
